...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@job-portal-demo.wjac65f.mongodb.net/?retryWrites=true&w=majority&appName=job-portal-demo`;
