...
export const Myjob = () => {
  ...
  const indesxOfFirstItem = indexofLasItem - itemsPerPage;
  const currentJobs = jobs.slice(indesxOfFirstItem, indexofLasItem);

  // newt btn & previous btn
  const nextPage = () => {
    if (indexofLasItem < jobs.length) {
